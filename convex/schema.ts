...
const requirementTemplateType = v.union(
...
const procoreEntityType = v.union(
  v.literal("project"),
  v.literal("vendor")
);

const shieldEntityType = v.union(
  v.literal("project"),
  v.literal("subcontractor")
);
...
const procoreSyncType = v.union(
  v.literal("projects"),
  v.literal("vendors"),
  v.literal("compliance_push")
);

const procoreSyncStatus = v.union(
  v.literal("started"),
  v.literal("completed"),
  v.literal("failed")
);
